...
export default function AvailabilityCalendarAdmin() {
  ...
  return (
    <div className="card space-y-5">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div>
          <h3 className="text-xl font-semibold">Gestión de disponibilidad</h3>
          <p className="opacity-80">
            Bloquea rangos de fechas o elimina bloqueos existentes.
          </p>
        </div>
        ...
        <DayPicker
          ...
          footer={
            <div className="text-sm opacity-80">
              Selecciona un rango de fechas para bloquearlo.
            </div>
          }
        />
      </div>
      ...
      <div className="space-y-4">
        <div className="grid md:grid-cols-3 gap-3">
          <input
            ...
            placeholder="Nota (opcional): motivo o detalles"
          />
          <button
